...
\begin{itemize}
  ...
  \item Among many sites of this civilisation discovered so far, the Harappan site was the first to be discovered in 1921 and hence the civilisation is also called as Harappan Civilisation or Harappan Culture.
\end{itemize}
\end{document}
